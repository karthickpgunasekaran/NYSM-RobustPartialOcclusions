...
# artifact_type = 0
#Change these
# path_org = './dataset/'+str(artifact)+'/'+str(artifact_type)+'/'
# print(path_org)
# train_path='./dataset/'+str(artifact)+'/split/'+str(artifact)+'/train/'
# test_path = './dataset/'+str(artifact)+'/split'+str(artifact)+'/test/'
...
for i in range(0,4):
    ...
    artifact_type = i
    path_org = './dataset/'+str(artifact)+'/'+str(artifact_type)+'/'
    print('path_org',path_org)

    train_path='./dataset/'+str(artifact)+'/split/'+str(artifact_type)+'/train/'
    print('train_path',train_path)
    test_path = './dataset/'+str(artifact)+'/split/'+str(artifact_type)+'/test/'
