...
class  Controller: 
    def __init__(self,artifact,artifact_type):
        ...
        self.images_dir = "/mnt/nfs/scratch1/mnabail/dataset682/"+str(artifact)+"/train/"+str(artifact_type)+"/"
        self.images_dir_test = "/mnt/nfs/scratch1/mnabail/dataset682/"+str(artifact)+"/test/"+str(artifact_type)+"/"
        self.store_dir = "/mnt/nfs/scratch1/mnabail/output682/"+str(artifact)+"/"+str(artifact_type)+"/"
