# -*- coding: utf-8 -*-
"""Copy of 682_main_test

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1i1vvwRwzm5VowZsG5Lx5MeIzf4AoCIo-
"""
...
class  Controller: 
    def __init__(self,artifact,artifact_type):
        ...
        self.images_dir = "/content/drive/My Drive/gypsum/"+str(artifact)+"/"+str(artifact_type)+"/"

        #concerned with this only
        self.images_dir_test = '/content/drive/My Drive/gypsum/'+str(artifact)+"/test/"+str(artifact_type)+"/"
        print('From test directory',self.images_dir_test)

        
        # #added this for location of models 
        # self.model_location - '/content/drive/My Drive/gypsum/models'+str(artifact)+"/"+str(artifact_type)+"/""
        artifact = "0-0"
        # self.check_point_path = "/content/drive/My Drive/gypsum/models/"+str(artifact)+"/"+str(artifact_type)+"/"
        self.check_point_path = "/content/drive/My Drive/gypsum/models/"+str(artifact)+"/"

        self.plot = self.images_dir+"plot/"
    ...
    def loadmodel(self,model_name):
        ...
        print('chk path',self.check_point_path +model_name)
    ...
    def predict(self,model):
        ...
        for data in self.dataloaders['test']:
            ...
            top_5_ps, top_5_classes = output.topk(5, dim=1)
            # print('top_5_ps',top_5_ps)
            # print('top_5_classes',len(top_5_classes))
            # print('top_5_classes',top_5_classes)
            
            for vals in range(0,output.shape[0]):
              # print('outside if top 5',labels[vals].item() )
              if labels[vals] in top_5_classes[vals]:
                # print('in top 5',labels[vals].item() )
                top_5_val=top_5_val+1
            num_samples += prediction.size(0)
            print('Iteration', count)
        
        acc = float(num_correct) / num_samples
        top_5_val_acc = float(top_5_val) / num_samples


        print('Accuracy of test data :', acc)
        print('top_5_val of test data :', top_5_val_acc)
    ...
    def load_model(self,model_name):
      print('load_model chk path',self.check_point_path)
      last_ver = -1
      #load all the models
      ...
      for m in list_models:
            ...
            if names[0]+"_"+names[1] == model_name:
                  #update the epoch to latest 
                  last_ver = max(last_ver,int(names[2]))

      #No model found with current name model_name in the directory
      if last_ver ==-1:
            return None  
      print("Returning model version : ",str(last_ver))
      print('here',model_name+"_"+str(last_ver)+"_model.pth")
    ...
    def test_all_models(self):
        ...
        for model_name,params in self.all_models.items():
                ...
                print('@@@@@ MODEL TYPE ',model_name,'  params',params,'@@@@@')
