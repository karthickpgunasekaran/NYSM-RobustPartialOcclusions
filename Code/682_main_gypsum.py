...
class  Controller: 
    def __init__(self,artifact,artifact_type):
        ...
        self.images_dir = "/mnt/nfs/scratch1/riteshkumar/kn_data/dataset682/"+str(artifact)+"/train/"+str(artifact_type)+"/"
        self.images_dir_test = "/mnt/nfs/scratch1/riteshkumar/kn_data/dataset682/"+str(artifact)+"/test/"+str(artifact_type)+"/"
        self.store_dir = "/mnt/nfs/scratch1/riteshkumar/kn_code/output/"+str(artifact)+"/"+str(artifact_type)+"/"
        self.check_point_path = self.store_dir+"models/"
    ...
    def initialize_data(self):
        ...
        self.all_models = {'googlenet':{'lr':0.0001, 'optim':"adam"}, 'densenet121':{'lr':0.0001, 'optim':"adam"}}
        ...
        for epoch in range(1, self.num_epochs + 1):
            ...
            for t in ['train', 'val']:
                    ...
                    if t == 'val' and epoch_acc > best_acc:
                        ...
                        self.checkpoint(model.state_dict(),epoch_loss,epoch,self.learning_rate)
                    if t == 'val':
...
def training_phase():
    ...
    #all_data ={'13':[0,1,2,3],'23':[0,1,2,3],'33':[0,1,2,3]}
    all_data ={'13':[3]}
